...
1. An R script with a single `blueprint()` command. This file details how to generate the desired dataset and optionally includes arbitrary metadata at dataset/table level.
1. A CSV file with, at minimum, the columns `name`, `type`, and `description`. This file enumerates the variable-level metadata.

Here is an example blueprint R file:
