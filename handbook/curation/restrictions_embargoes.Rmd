...
A restricted dataset, variable, or measure is restricted to a group or people or institutions with no time frame for release.

### embargo

An embargo is a dataset, variable, or measure that is not available until a certain date. 
