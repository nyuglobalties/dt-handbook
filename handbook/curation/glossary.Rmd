...
## Data Infomraiton Knowledge Wisdom (DIKW) Pyramid
...
A lightweight and simple markup language for creating formatted text. For a cheatsheet that covers most markdown syntax see: <https://www.markdownguide.org/cheat-sheet/> 
...
- [Dataverse](https://dataverse.org/): An open source repository that maintains its collections in <schema.org>'s schemas. 
...
- [Qualitative Data Repository (QDR)](https://data.qdr.syr.edu/): A Dataverse instance dedicated to archiving and preserving data generated through qualitatie research methods. This project is hosted at the Center for Qualitative and Multi-Method Inquiry at Syracuse University.
